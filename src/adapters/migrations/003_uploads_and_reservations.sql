...
INSERT INTO operations (id, kind, request_id, payload_json, state, created_at, updated_at)
SELECT id, kind, json_extract(payload_json, '$.requestId'), payload_json, state, created_at, updated_at
FROM operations_v2;

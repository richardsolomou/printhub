...
export function resinVolumeMl(request: Pick<PublicPrintRequest, 'estimatedResinMl' | 'printer'>, count = 1) {
  return !request.printer || request.estimatedResinMl === undefined || request.estimatedResinMl <= 0
    ? undefined

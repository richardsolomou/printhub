        ...
        '/**': {
          headers: {
            'Content-Security-Policy':
              "default-src 'self'; script-src 'self' 'unsafe-inline' https://t.ras.sh; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://t.ras.sh; font-src 'self'; connect-src 'self' https://t.ras.sh; worker-src 'self' blob:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'",

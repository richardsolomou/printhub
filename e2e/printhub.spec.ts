...
test('admin setup, upload, viewer, settings, invite, and sign out', async ({ page, browser }) => {
  ...
  await expect(page.getByRole('heading', { name: 'Your private resin print queue' })).toBeVisible()
  await expect(page.getByText('Move each copy through Queue, Printing, Post-processing, and Ready.')).toBeVisible()
